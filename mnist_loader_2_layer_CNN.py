...
class Net(nn.Module):
    def __init__(self):
        super().__init__()
        #Bild startar 1 * 28 * 28
        self.conv1 = nn.Conv2d(1, 16, kernel_size=3, padding=1)
        self.conv2 = nn.Conv2d(16, 32, kernel_size=3, padding=1)
        #Halveras till 16 *14*14 och sen 32*7*7
...
def main():
    ...
    out_dir = os.path.join("outputs", f"mnist__2layer_cnn__run_{run_id}")
    ...
    writer.add_text(
        ...
        "\n".join(
            [
                ...
                "",
                "Den här körningen tränar en 2-layer CNN på MNIST. Tanken är att se hur stor skillnad det gör att byta från FFN till en CNN — alltså om det räcker med två conv-lager för att få upp accuracy.",
                "",
