...
def main():
    ...
    out_dir = os.path.join("outputs", f"mnist__baseline_ffn__run_{run_id}")
    ...
    val_size = min(training_config["val_size"], len(full_train) - 1)
    ...
    val_set = Subset(full_train, val_part.indices)
